...
export const getVideoDetails = createAsyncThunk(
  ...
  parseData = async (item) => {
  const channelResponse = await axios.get(`https://youtube.googleapis.com/youtube/v3/channel?part=snippet,statistics&id=${item.snippet.channelId}&key=${API_KEY}`)
